...
#define CLOCK_UI_PRIORITY            TASK_PRIORITY_MEDIUM_LOW


#define MISSION_CONTROL_PRIORITY    (TASK_PRIORITY_MEDIUM - 1)
#define SENSOR_FARM_PRIORITY         TASK_PRIORITY_MEDIUM

#define TRAIN_CONTROL_PRIORITY      (TASK_PRIORITY_MEDIUM - 2)
#define TRAIN_BLASTER_PRIORITY      (TASK_PRIORITY_MEDIUM - 3)
#define TRAIN_MASTER_PRIORITY       (TASK_PRIORITY_MEDIUM - 4)
#define TRAIN_TRACK_ADMIN_PRIORITY  (TASK_PRIORITY_MEDIUM - 4)

#define TRAIN_COURIER_PRIORITY      (TASK_PRIORITY_MEDIUM + 1)

#define TRACK_RESERVATION_PRIORITY  TASK_PRIORITY_MEDIUM

#define TRAIN_CONSOLE_PRIORITY      TASK_PRIORITY_MEDIUM

#define TC_DRIVER_COURIER_PRIORITY  (TASK_PRIORITY_MEDIUM_LOW + 2)
