...
static inline void tr_setup_physics(train_context* const ctxt) {
    ...
    switch (ctxt->off) {
    case 1:
        ctxt->velocity[TRACK_STRAIGHT][5] = 2826;
        ctxt->velocity[TRACK_COMBO][5]    = 2826;
        ctxt->velocity[TRACK_CURVED][5]   = 2826;
        ctxt->velocity[TRACK_STRAIGHT][6] = 3441;
        ctxt->velocity[TRACK_COMBO][6]    = 3441;
        ctxt->velocity[TRACK_CURVED][6]   = 3441;
        ctxt->velocity[TRACK_STRAIGHT][7] = 3790;
        ctxt->velocity[TRACK_COMBO][7]    = 3790;
        ctxt->velocity[TRACK_CURVED][7]   = 3790;
        ctxt->velocity[TRACK_STRAIGHT][8] = 4212;
        ctxt->velocity[TRACK_COMBO][8]    = 4212;
        ctxt->velocity[TRACK_CURVED][8]   = 4212;
        ctxt->velocity[TRACK_STRAIGHT][9] = 4570;
        ctxt->velocity[TRACK_COMBO][9]    = 4570;
        ctxt->velocity[TRACK_CURVED][9]   = 4570;
        ctxt->velocity[TRACK_STRAIGHT][10] = 4994;
        ctxt->velocity[TRACK_COMBO][10]    = 4994;
        ctxt->velocity[TRACK_CURVED][10]   = 4994;
        ctxt->velocity[TRACK_STRAIGHT][11] = 4869;
        ctxt->velocity[TRACK_COMBO][11]    = 4869;
        ctxt->velocity[TRACK_CURVED][11]   = 4869;
        break;
    case 2:
        ctxt->velocity[0][5] = 3488;
        ctxt->velocity[0][6] = 3621;
        ctxt->velocity[0][7] = 4299;
        ctxt->velocity[0][8] = 4661;
        ctxt->velocity[0][9] = 6460;
        ctxt->velocity[0][10] = 5251;
        ctxt->velocity[0][11] = 6463;
        ctxt->velocity[1][5] = 3488;
        ctxt->velocity[1][6] = 3621;
        ctxt->velocity[1][7] = 4250;
        ctxt->velocity[1][8] = 4661;
        ctxt->velocity[1][9] = 5025;
        ctxt->velocity[1][10] = 5249;
        ctxt->velocity[1][11] = 5276;
        ctxt->velocity[2][5] = 3488;
        ctxt->velocity[2][6] = 3621;
        ctxt->velocity[2][7] = 4250;
        ctxt->velocity[2][8] = 4661;
        ctxt->velocity[2][9] = 5025;
        ctxt->velocity[2][10] = 5249;
        ctxt->velocity[2][11] = 5276;
        break;
    case 3:
        ctxt->velocity[TRACK_STRAIGHT][5] = 3347;
        ctxt->velocity[TRACK_COMBO][5]    = 3347;
        ctxt->velocity[TRACK_CURVED][5]   = 3347;
        ctxt->velocity[TRACK_STRAIGHT][6] = 3748;
        ctxt->velocity[TRACK_COMBO][6]    = 3748;
        ctxt->velocity[TRACK_CURVED][6]   = 3748;
        ctxt->velocity[TRACK_STRAIGHT][7] = 4116;
        ctxt->velocity[TRACK_COMBO][7]    = 4116;
        ctxt->velocity[TRACK_CURVED][7]   = 4116;
        ctxt->velocity[TRACK_STRAIGHT][8] = 4597;
        ctxt->velocity[TRACK_COMBO][8]    = 4597;
        ctxt->velocity[TRACK_CURVED][8]   = 4597;
        ctxt->velocity[TRACK_STRAIGHT][9] = 5060;
        ctxt->velocity[TRACK_COMBO][9]    = 5060;
        ctxt->velocity[TRACK_CURVED][9]   = 5060;
        ctxt->velocity[TRACK_STRAIGHT][10] = 5161;
        ctxt->velocity[TRACK_COMBO][10]    = 5161;
        ctxt->velocity[TRACK_CURVED][10]   = 5161;
        ctxt->velocity[TRACK_STRAIGHT][11] = 5044;
        ctxt->velocity[TRACK_COMBO][11]    = 5044;
        ctxt->velocity[TRACK_CURVED][11]   = 5044;
        break;
    case 4:
        ctxt->velocity[TRACK_STRAIGHT][5] = 3966;
        ctxt->velocity[TRACK_COMBO][5]    = 3966;
        ctxt->velocity[TRACK_CURVED][5]   = 3966;
        ctxt->velocity[TRACK_STRAIGHT][6] = 4512;
        ctxt->velocity[TRACK_COMBO][6]    = 4512;
        ctxt->velocity[TRACK_CURVED][6]   = 4512;
        ctxt->velocity[TRACK_STRAIGHT][7] = 4913;
        ctxt->velocity[TRACK_COMBO][7]    = 4913;
        ctxt->velocity[TRACK_CURVED][7]   = 4913;
        ctxt->velocity[TRACK_STRAIGHT][8] = 5535;
        ctxt->velocity[TRACK_COMBO][8]    = 5535;
        ctxt->velocity[TRACK_CURVED][8]   = 5535;
        ctxt->velocity[TRACK_STRAIGHT][9] = 5718;
        ctxt->velocity[TRACK_COMBO][9]    = 5718;
        ctxt->velocity[TRACK_CURVED][9]   = 5718;
        ctxt->velocity[TRACK_STRAIGHT][10] = 5472;
        ctxt->velocity[TRACK_COMBO][10]    = 5472;
        ctxt->velocity[TRACK_CURVED][10]   = 5472;
        ctxt->velocity[TRACK_STRAIGHT][11] = 5733;
        ctxt->velocity[TRACK_COMBO][11]    = 5733;
        ctxt->velocity[TRACK_CURVED][11]   = 5733;
        break;
    case 6:
        ctxt->velocity[TRACK_STRAIGHT][5] = 1732;
        ctxt->velocity[TRACK_COMBO][5]    = 1732;
        ctxt->velocity[TRACK_CURVED][5]   = 1732;
        ctxt->velocity[TRACK_STRAIGHT][6] = 2028;
        ctxt->velocity[TRACK_COMBO][6]    = 2028;
        ctxt->velocity[TRACK_CURVED][6]   = 2028;
        ctxt->velocity[TRACK_STRAIGHT][7] = 2429;
        ctxt->velocity[TRACK_COMBO][7]    = 2429;
        ctxt->velocity[TRACK_CURVED][7]   = 2429;
        ctxt->velocity[TRACK_STRAIGHT][8] = 2995;
        ctxt->velocity[TRACK_COMBO][8]    = 2995;
        ctxt->velocity[TRACK_CURVED][8]   = 2995;
        ctxt->velocity[TRACK_STRAIGHT][9] = 3676;
        ctxt->velocity[TRACK_COMBO][9]    = 3676;
        ctxt->velocity[TRACK_CURVED][9]   = 3676;
        ctxt->velocity[TRACK_STRAIGHT][10] = 4584;
        ctxt->velocity[TRACK_COMBO][10]    = 4584;
        ctxt->velocity[TRACK_CURVED][10]   = 4584;
        ctxt->velocity[TRACK_STRAIGHT][11] = 5864;
        ctxt->velocity[TRACK_COMBO][11]    = 5864;
        ctxt->velocity[TRACK_CURVED][11]   = 5864;
        break;
    }
