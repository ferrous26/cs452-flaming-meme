...
#define	TIMER3_BASE	0x80810080
        #define TIMER3_LOAD     0x00
        #define TIMER3_VALUE    0x04
        #define TIMER3_CONTROL  0x08
#define TIMER4_BASE     0x80810060
        #define TIMER4_VALUE    0x00
        #define TIMER4_CONTROL  0x04
...
#define UART_LCRH_OFFSET	0x8	// low 7 bits
	...
	#define FEN_MASK	0x10	// fifo (enable) mask
