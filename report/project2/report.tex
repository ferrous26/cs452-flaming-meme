...
\begin{center}
\includegraphics[scale=0.25]{tasks}
\end{center}
...
When a \ttt{Train Blaster} task is signaled to start moving it creates a
...
decision of what to forward back to the \ttt{Train Blaster}. The
...
\ttt{Train Console} in a synchronized state with the \ttt{Train Blaster} so we
