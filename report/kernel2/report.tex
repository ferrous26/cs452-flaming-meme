...
\ttt{Send}ing a message follows the required API with the addition of
\ttt{IMPOSSIBLE\_TASK} maps to a return code of \ttt{-1}, and is used
when the message being sent \ttt{NOT\_ENUF\_MEMORY}.
