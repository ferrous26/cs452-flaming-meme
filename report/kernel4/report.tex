...
Delay the calling task by \ttt{ticks} clock ticks. The actual delay is
guaranteed to be at least \ttt{ticks} clock ticks, but may be longer
...
Delay the calling task until the system time is \ttt{ticks} clock
ticks. The actual delay is guaranteed to be at least until \ttt{ticks}
...
was interrupted performing real work between pollings. In this case,
