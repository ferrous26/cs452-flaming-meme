...
kernel.elf: $(OBJS) $(KERN_CODE) $(TASKS) libdebug libscheduler libmemory libcircular libio libvt100 libclock
	$(LD) $(LDFLAGS) -o $@ $(KERN_CODE) $(TASKS) -lscheduler -ldebug -lvt100 -lio -lcircular -lclock -lmemory -lgcc
